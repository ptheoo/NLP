...
def run_spark_pipeline_word2vec():
    """
    Phân tích cảm xúc dùng Word2Vec embeddings thay vì TF-IDF.
    """

    print("=== 1. Khởi tạo Spark ===")
    spark = SparkSession.builder.appName("SentimentAnalysis_Word2Vec").getOrCreate()
